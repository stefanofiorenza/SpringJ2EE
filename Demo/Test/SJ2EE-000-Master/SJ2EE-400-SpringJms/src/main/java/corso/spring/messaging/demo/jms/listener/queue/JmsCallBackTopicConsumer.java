package corso.spring.messaging.demo.jms.listener.queue;
...
public class JmsCallBackTopicConsumer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			destination =(Topic)JbossContext.lookup(JmsCallBackTopicConsumer.DESTINATION);
