...
//	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			topicConnectionFactory = (TopicConnectionFactory) context.lookup(JBossJndiUtils.CONNECTION_FACTORY_JBOSS71);			
			destination =(Topic)context.lookup(JBossJndiUtils.TOPIC_JBOSS71);
