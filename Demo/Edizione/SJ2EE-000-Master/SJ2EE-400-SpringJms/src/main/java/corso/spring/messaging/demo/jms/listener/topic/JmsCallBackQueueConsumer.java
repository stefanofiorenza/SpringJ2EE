package corso.spring.messaging.demo.jms.listener.topic;
...
import corso.spring.messaging.demo.jms.listener.TextMessageListener;



public class JmsCallBackQueueConsumer {
	...
	public JmsCallBackQueueConsumer(){
		try{
			...
			//Ottengo un riferimento alla destination
			 queueReference = (Queue)context.lookup(JmsCallBackQueueConsumer.DESTINATION);
	...
	public static void main(String[] args) {
		JmsCallBackQueueConsumer queueConsumer = new JmsCallBackQueueConsumer();
