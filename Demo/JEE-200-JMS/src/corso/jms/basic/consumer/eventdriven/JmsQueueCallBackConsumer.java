...
public class JmsQueueCallBackConsumer {
	...
	public JmsQueueCallBackConsumer(){
		try{
			...
			//Ottengo un riferimento alla destination
			 queueReference = (Queue)context.lookup(JmsQueueCallBackConsumer.DESTINATION);
	...
	public static void main(String[] args) {
		JmsQueueCallBackConsumer queueConsumer = new JmsQueueCallBackConsumer();
